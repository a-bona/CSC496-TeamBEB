    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xs-10" class="pagecontent">
          <div class="container">
            <div class="col-xs-5 forTiles" id="employee">
                <li><a class="tiles" href="employeeLookup.php"><i class="fa fa-users"></i>Employees</a></li>
              </div>
            <div class="col-xs-5 forTiles" id="customer">
                <li><a class="tiles" href="customerLookup.php"><i class="fa fa-building"></i>Customers</a></li>
            </div>
          </div>​
        </div>
        <div class="col-xs-10" class="pagecontent">
          <div class="container">  
            <div class= "col-xs-5 forTiles" id="jobs">
                <li><a class="tiles" href="jobLookup.php"><i class="fa fa-briefcase"></i>Jobs</a></li>
            </div>
            <div class= "col-xs-5 forTiles" id="schedule">
                <li><a class="tiles" href="/calendar/index.html"><i class="fa fa-calendar"></i>Schedule</a></li>
            </div>
        </div>
