<?php
  ...
  if(isset($_POST["submit"])) {
    ...
    $sql = ("INSERT INTO customers (Name, Division, Address, City, State, County, Country, Website, Email, Phone)
                       VALUES (:Name, :Division, :Address, :City, :State, :County, :Country, :Website, :Email, :Phone)");
    ...
    if ($success) {
        ...
        header("location: customerLookupV2.php");
    }
    ...
    <div class="container-fluid">
      ...
      <form action="addCustomer.php" method="POST">
        ...
        <div class="center row topBuffer">
          <input class="addSubBtn" type="submit" name="submit" value="Add Customer">
        </div>
      </form>
